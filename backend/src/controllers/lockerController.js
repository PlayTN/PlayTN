  ...
  try {
    ...
    const cellsFormattate = cells.map((cell) => {
      ...
      const cellFormattata = {
        ...
        stato: cell.stato, // Includi lo stato per il frontend
      ...
      // Campi opzionali per tipo pickup
      if (cell.tipo === 'ordini') {
        cellFormattata.storeName = null;
        cellFormattata.availableUntil = null;
      }

      // Campi opzionali per tipo borrow
      if (cell.tipo === 'prestito') {
        cellFormattata.borrowDuration = null;
      }
